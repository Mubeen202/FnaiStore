...
<form action="{Yii::getAlias('@web')}/design/box-save" method="post" id="box-save">
  ...
  <div class="popup-heading">
    {$smarty.const.TEXT_WIDGET_BATCH_SELCTED_PRODUCTS}
  </div>
  <div class="popup-content">
    ...
    <div class="tabbable tabbable-custom">
      <ul class="nav nav-tabs">
        ...
        <li class="active" data-bs-toggle="tab" data-bs-target="#type"><a>{$smarty.const.TEXT_WIDGET_BATCH_SELCTED_PRODUCTS}</a></li>
      ...
      <div class="tab-content">
        <div class="tab-pane active menu-list" id="type">
          ...
          <div class="setting-row">
            <label for="">Hide total price</label>
            {Html::dropDownList('setting[0][hide_total_price]', $settings[0].hide_total_price, ['0'=>'No', '1'=>'Yes'], ['class'=>"form-control"])}
          </div>

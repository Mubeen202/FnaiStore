            ...
            <div class="tab-content">
                <div class="tab-pane active menu-list" id="type">
                    ...
                    <div class="setting-row">
                        <label for="">{$smarty.const.TEXT_SHORT_VIEW}</label>
                        <select name="setting[0][short_view]" id="" class="form-control">
                            <option value=""{if $settings[0].short_view == ''} selected{/if}>{$smarty.const.TEXT_NO}</option>
                            <option value="1"{if $settings[0].short_view == '1'} selected{/if}>{$smarty.const.TEXT_YES}</option>
                        </select>
                    </div>
                    <div class="setting-row">
